...
Based on: stock_priecePredictio_PROJECT.ipynb
...
@st.cache_resource
def train_best_model(_df_id, df_len):
...
def main():
    ...
    with st.sidebar:
        ...
        st.markdown(
            ...
            "📓 Notebook:<br><b>stock_priecePredictio_PROJECT.ipynb</b><br><br>"
    ...
    with tab5:
        st.markdown('<div class="section-title">Single-Day Prediction</div>',
                    unsafe_allow_html=True)
        st.markdown("Uses **Linear Regression** (`best_model.pkl`).")
